...
class SoftSaaSTypography {
  ...
  static TextStyle bodyMediumTertiary(Brightness brightness) => bodyMedium(
    brightness,
  ...
  static TextTheme getTextTheme(Brightness brightness) => TextTheme(
    displayLarge: heading3(
      brightness,
    ).copyWith(fontSize: SoftSaaSTokens.fontSize3XL),
    displayMedium: heading3(
      brightness,
    ).copyWith(fontSize: SoftSaaSTokens.fontSize2XL),
    titleLarge: heading3(brightness),
    titleMedium: heading4(brightness),
    bodyLarge: bodyMedium(
      brightness,
    ).copyWith(fontSize: SoftSaaSTokens.fontSizeMD),
